    ...
    private void startCamera() {
        cameraProviderFuture.addListener(() -> {
            try {
                ...
                QrCode.this.bindCameraPreview(cameraProvider);
            } catch (ExecutionException | InterruptedException e) {
                Toast.makeText(QrCode.this, "Error starting camera " + e.getMessage(), Toast.LENGTH_SHORT).show();
            }
            ...
            public void run() {
                ImageAnalysis imageAnalysis =
                        new ImageAnalysis.Builder()
                                ...
                                .build();
                imageAnalysis.setAnalyzer(ContextCompat.getMainExecutor(QrCode.this), new QRCodeImageAnalyzer(new QRCodeFoundListener() {
                    @Override
                ...
                Camera camera = cameraProvider.bindToLifecycle((LifecycleOwner)QrCode.this, cameraSelector, imageAnalysis, preview);
            }
        });
    }
}